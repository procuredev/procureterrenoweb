...
const rows = [
  { id: 1, lastName: 'Snow', firstName: 'Jon', age: 35, avatar: '#' },
  { id: 2, lastName: 'Lannister', firstName: 'Cersei', age: 42, avatar: '#' },
  { id: 3, lastName: 'Lannister', firstName: 'Jaime', age: 45, avatar: '#' },
  { id: 4, lastName: 'Stark', firstName: 'Arya', age: 16, avatar: '#' },

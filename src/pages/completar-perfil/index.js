  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      await updateUserData(authUser.uid, updatedValues)
        .then(() => {
          // Después de que se haya actualizado la información del usuario, marca el perfil como completado
          return updateUserData(authUser.uid, { completedProfile: true })
        })
        .then(() => {
          // Después de que se haya marcado el perfil como completado, realiza cualquier acción adicional
